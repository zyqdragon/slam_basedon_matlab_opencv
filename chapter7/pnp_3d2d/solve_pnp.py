...
dist_coefs = np.array([-0.189314, 0.444657, -0.00116176, 0.00164877, -2.57547], dtype=np.double)# 求解相机位姿
...
Cz = z*-1
# 输出相机位置
print("------rotation angle is:",Cx, Cy, Cz)# 输出相机旋转角
print(thetaX, thetaY, thetaZ)# 对第五个点进行验证
...
pixel1 = np.dot(pixel, np.array([100, 100, 0, 1], dtype=np.double))
